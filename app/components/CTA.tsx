  ...
  return (
    <section className="relative mt-20 lg:mt-50">
      <div className="flex flex-col items-center justify-between lg:flex-row">
        ...
        >
          <h2 className="mt-20 ml-0 text-2xl/6 font-bold text-white sm:text-[2rem]/10 md:text-[2.5rem]/10 lg:mt-40 lg:ml-32 lg:text-3xl xl:text-[3rem]/12 2xl:text-[3.5rem]/14">
            Узнайте свои
            <br />
            шансы на успех!
          </h2>
