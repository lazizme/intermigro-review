...
export default function TheBestLawyers() {
  return (
    <section className="relative px-5 py-10 md:px-20 md:py-16">
      <div className="bg-gray-light flex flex-col gap-6 rounded-[2.5rem] px-6 py-10 md:grid md:grid-cols-3 md:items-center md:gap-4 md:px-16 md:py-0">
        <ResponsiveScalesIcon className="text-brand absolute top-6 right-1.5 shrink-0 scale-75 md:hidden" />
        <h2 className="w-2/3 text-2xl font-medium md:w-auto md:py-12.5 md:text-3xl">
          Лучшие адвокаты и аккредитованные представители
        </h2>
        <p className="text-gray-medium text-lg font-medium md:py-12.5">
