  ...
  const options = [
    {
      title: (
        <>
          ВНЖ для фрилансеров, удаленных сотрудников{" "}
          <span className="text-nowrap">и предпринимателей</span>
        </>
      ),
    ...
    },
    {
      ...
      isHighlight: true,
      description:
        "Виза для специалистов с высшим образованием и опытом работы, у которых уже есть предложение о работе от немецкого работодателя или которые планируют поиск работы в Германии",
    },
    {
      title: "ВНЖ для воссоединения семьи",
      visa_type: "Familiennachzug",
      description: "Виза для родителей, супругов и детей резидентов или граждан Германии",
    },
    {
